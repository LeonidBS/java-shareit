...
public interface ItemService {
    List<ItemDtoWithBookings> findAllByOwnerId(Integer ownerId, int from, int size);

    ItemDtoWithBookings findByIdWithOwnerValidation(Integer itemId, Integer userId);
